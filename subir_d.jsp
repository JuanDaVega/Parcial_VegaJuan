...
<%
    ...
    String archivoDirector = null;

    // Obtener anteproyecto y datos
    try {
        ...
        // Obtener archivo subido por el director (si existe)
        if (tieneAnteproyecto) {
            ...
            if (rs.next()) {
                archivoDirector = rs.getString("archivo_ruta");
            }
        }
    ...
    if (tieneAnteproyecto && ServletFileUpload.isMultipartContent(request)) {
        ...
        try {
            ...
            if (fileName != null) {
                ...
                ps.executeUpdate();
                archivoDirector = "subidas/" + fileName;
            }
...
<html>
<head>
    <title>Subir Informe de Director</title>
...
<br>
    ...
    <% if (tieneAnteproyecto) { %>
        ...
        <form action="subir_d.jsp" method="post" enctype="multipart/form-data" class="mt-4">
            ...
            <div class="text-center">
                ...
                <a href="director.jsp" class="btn btn-secondary ms-2">Cancelar</a>
            </div>
        </form>

        <% if (archivoDirector != null) { %>
            <div class="alert alert-success mt-4 text-center">
                <strong>Archivo subido:</strong>
                <a href="<%= archivoDirector %>" target="_blank">
                    <%= archivoDirector.substring(archivoDirector.lastIndexOf('/') + 1) %>
                </a>
            </div>
        <% } else { %>
    ...
    <div class="text-center mt-5">
        <a href="director.jsp" class="btn btn-outline-success">Volver</a>
    </div>
