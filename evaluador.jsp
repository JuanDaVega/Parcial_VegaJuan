...
<%
    ...
    if (idEvaluador == null) {
        mensaje = "No se encontró el evaluador en la sesión.";
    } else {
        try {
            ...
            // Consulta SQL para obtener los anteproyectos del evaluador con los directores ya asignados
            String sql = "SELECT a.id AS id_anteproyecto, a.titulo, al.nombre AS alumno_nombre, e.nombre AS director_nombre, " +
                         "ae.nombre AS evaluador_nombre " +
                         "FROM anteproyecto a " +
                         "LEFT JOIN alumno al ON a.id_alumno = al.id " +
                         "LEFT JOIN director e ON a.id_director = e.id " +
                         "LEFT JOIN evaluador ae ON a.id_evaluador = ae.id " +
                         "WHERE a.id_evaluador = ?";
            ps = con.prepareStatement(sql);
            ps.setInt(1, idEvaluador);  // Usamos el id_evaluador de la sesión
            rs = ps.executeQuery();
            ...
            while (rs.next()) {
                ...
                row.put("director", rs.getString("director_nombre") != null ? rs.getString("director_nombre") : "Sin asignar");
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><%= row.get("director") %></td>
                                    <td><%= row.get("evaluador") %></td>
                                    <td>
                                        <form action="califi_ev.jsp" method="post" style="display:inline;">
            ...
            <div class="col-md-6 ">
                <div class="card shadow">
                    <div class="card-body text-center">
                        ...
                        <form action="subir_e.jsp" method="post">
