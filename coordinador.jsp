...
<body class="bg-light">
    <div class="container mt-5">
        <h2 class="mb-4 text-center">Panel de Coordinación</h2>
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <form action="anteproyectos.jsp" method="post">
                        <button type="submit" name="rol" value="Coordinacion" class="btn btn-role admin-btn">
                            Ingresar
                        </button>
                    </form>
                </div>
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <h4 class="card-title">Informes de Anteproyectos</h4>
                    <p class="card-text">Crea la idea de anteproyecto, agregar director e informes de estado.</p>
