...
<%
    ...
    try {
        ...
        // Obtener archivo subido por el alumno (si existe)
        if (tieneAnteproyecto) {
            ...
            if (rs.next()) {
                archivoAlumno = rs.getString("archivo_ruta");
            }
        }
    ...
    if (tieneAnteproyecto && ServletFileUpload.isMultipartContent(request)) {
        ...
        try {
            ...
            if (fileName != null) {
                ...
                ps.executeUpdate();
                archivoAlumno = "subidas/" + fileName;
            }
...
<br>
    ...
    <% if (tieneAnteproyecto) { %>
        ...
        <form action="subir.jsp" method="post" enctype="multipart/form-data" class="mt-4">
            ...
            <div class="text-center">
                ...
                <a href="alumno.jsp" class="btn btn-secondary ms-2">Cancelar</a>
            </div>
        </form>
        ...
        <% if (archivoAlumno != null) { %>
            <div class="alert alert-success mt-4 text-center">
                ...
                <a href="<%= archivoAlumno %>" target="_blank">
                    <%= archivoAlumno.substring(archivoAlumno.lastIndexOf('/') + 1) %>
                </a>
            </div>
        <% } else { %>
    ...
    <div class="text-center mt-5">
        <a href="alumno.jsp" class="btn btn-outline-success">Volver</a>
    </div>
